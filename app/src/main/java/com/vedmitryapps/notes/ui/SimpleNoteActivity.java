...
public class SimpleNoteActivity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener  {
    ...
    private Button mCancelNotification, mMenuButton;
    ...
    private void loadPreferences(){
        ...
        mHours = mSharedPreferences.getInt(Constants.MORNING_TIME_HOURS, 8);
    ...
    private void initView() {
        ...
        mText.setTextSize(mSharedPreferences.getInt(Constants.TASK_FONT_SIZE, 17));
        mHead.setTextSize(mSharedPreferences.getInt(Constants.TASK_FONT_SIZE, 17));
