...
public class Constants {
    ...
    public static final String TASK_FONT_SIZE = "taskFontSize";
    public static final String CARD_FONT_SIZE = "cardFontSize";
    ...
    public static final long PERIOD_TREE_DAY = PERIOD_ONE_DAY * 3;
    public static final long PERIOD_WEEK = PERIOD_ONE_DAY * 7;
    public static final long PERIOD_MONTH = PERIOD_ONE_DAY * 31 ;
    ...
    public static final String RESTART_AMOUNT = "restart_amount";

    public static final int RATE_REQUEST_TIME = 25;
